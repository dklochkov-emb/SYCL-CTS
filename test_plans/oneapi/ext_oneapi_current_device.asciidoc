...
Estimated development time is half of day.
...
1. Positive case. This test can be performed by seting default device, calling the function sycl::ext::oneapi::experimental::this_thread::get_current_device 
...
1. Positive case. This test can be performed by checking default device, calling the function sycl::ext::oneapi::experimental::this_thread::set_current_device,
